...
// console.log(str2.indexOf("my",18))//the second argument tells from which index the search dhould begin
...
//console.log(`The utf-16 code${objstr.charCodeAt(0)} is equal to ${objstr.charAt(0)}`)
...
//an invalid UTF code so using codePointAt we can represent char with UTF number larger than that
